...
class DoublyLinkedList:
    ...
    def first_node(self):
        if self.is_empty():
            raise Empty("List is empty, it doesnt have first node!")
        return self._header._next

    def last_node(self):
        if self.is_empty():
            raise Empty("List is empty, it doesnt have last node!")
    ...
    def delete_node(self, node):
        if self.is_empty():  
            raise Empty("It is impossible to remove an element. List is empty!")
